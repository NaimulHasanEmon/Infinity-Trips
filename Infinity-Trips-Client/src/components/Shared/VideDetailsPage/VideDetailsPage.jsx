...
const VideDetailsPage = () => {
  ...
  return (
    <div className='mb-5 mt-2 spot-cart'>
      <div>
        <div>
          {/* Image and Spot Info */}
          <div className='flex gap-5'>
            ...
            <div className='w-1/4'>
              <p className='text-5xl font-bold mb-5'>
                {touristSpotName},{" "}
                <span className='text-2xl'>{countryName}</span>
              </p>
              {/* Taka */}
              <p className='text-3xl font-semibold flex items-center gap-1'>
                <div>
                  ...
                  >
                    <path
                      d='M40 256C40 136.706 136.706 40 256 40C375.294 40 472 136.706 472 256C472 375.294 375.294 472 256 472C136.706 472 40 375.294 40 256ZM256 24C127.87 24 24 127.87 24 256C24 384.13 127.87 488 256 488C384.13 488 488 384.13 488 256C488 127.87 384.13 24 256 24ZM80 256C80 158.798 158.798 80 256 80C353.202 80 432 158.798 432 256C432 353.202 353.202 432 256 432C158.798 432 80 353.202 80 256ZM256 64C149.961 64 64 149.961 64 256C64 362.039 149.961 448 256 448C362.039 448 448 362.039 448 256C448 149.961 362.039 64 256 64ZM184 136C184 131.582 187.582 128 192 128H224C246.091 128 264 145.909 264 168V216H308C312.418 216 316 219.582 316 224C316 228.418 312.418 232 308 232H264V360H276C298.091 360 316 342.091 316 320V312C316 307.582 312.418 304 308 304H300C295.582 304 292 300.418 292 296C292 291.582 295.582 288 300 288H308C321.255 288 332 298.745 332 312V320C332 350.928 306.928 376 276 376H256C251.582 376 248 372.418 248 368V232H200C195.582 232 192 228.418 192 224C192 219.582 195.582 216 200 216H248V168C248 154.745 237.255 144 224 144H192C187.582 144 184 140.418 184 136Z'
              ...
              {/* Location */}
              <p className='flex text-xl font-semibold items-center gap-1'>
              ...
              <p className='flex text-xl font-semibold items-center gap-1'>
                  ...
                  {seasonality === "Summer" ? (
                    <>
                      ...
                      >
                        <g>
                          <path
                            d='M-62.925-87.389h-6.44c-3.049,0-5.53,2.481-5.53,5.53v20.59c0,3.049,2.481,5.53,5.53,5.53h6.44
                    ...
                    h-6.44c-1.12,0-2.03-0.911-2.03-2.03v-20.59c0-1.12,0.911-2.03,2.03-2.03h6.44c1.12,0,2.03,0.911,2.03,2.03V-61.269z'
                          ></path>
                          <path
                            d='M-85.875-87.23h-19.04c-3.297,0-5.98,2.683-5.98,5.98v0.207c0,3.297,2.683,5.98,5.98,5.98h19.04
                    ...
                    h-19.04c-1.368,0-2.48-1.112-2.48-2.48v-0.207c0-1.368,1.112-2.48,2.48-2.48h19.04c1.368,0,2.48,1.112,2.48,2.48V-81.043z'
                          ></path>
                          <path
                            d='M-22.062-58.98c0-0.966-0.784-1.75-1.75-1.75s-1.75,0.784-1.75,1.75v6.683h-24.375c1.263-1.576,2.023-3.571,2.023-5.743
                    ...
                    c0-3.147,2.56-5.707,5.707-5.707h50.901c3.146,0,5.707,2.56,5.707,5.707v27.982c0,3.147-2.56,5.707-5.707,5.707H-71.126z'
                          ></path>
                          <circle cx='-97.962' cy='-49.679' r='3.167'></circle>
                          <circle cx='-78.962' cy='-49.679' r='3.167'></circle>
                          <circle cx='-67.979' cy='-71.313' r='1.8'></circle>
                          <path
                            d='M-38.146-43.063h-77.667c-0.966,0-1.75,0.784-1.75,1.75s0.784,1.75,1.75,1.75h77.667c0.966,0,1.75-0.784,1.75-1.75
                    S-37.179-43.063-38.146-43.063z'
                          ></path>
                          <path
                            d='M-27.146-43.063h-5c-0.966,0-1.75,0.784-1.75,1.75s0.784,1.75,1.75,1.75h5c0.966,0,1.75-0.784,1.75-1.75
                    S-26.179-43.063-27.146-43.063z'
                          ></path>
                        </g>
                        <g>
                          <path
                            d='M33.357-93.296h-1.145c-3.715,0-6.625,2.198-6.625,5.003v3.688c-1.187-0.07-4.16-0.172-9.844,0.038
                    ...
                    c0,2.806,2.91,5.003,6.625,5.003h1.145c0.967,0,1.75-0.784,1.75-1.75v-17.081C35.107-92.513,34.324-93.296,33.357-93.296z
                     M31.607-76.248c-1.536-0.166-2.52-0.939-2.52-1.471v-10.575c0-0.532,0.983-1.305,2.52-1.471V-76.248z'
                          ></path>
                          <path
                            d='M78.72-72.715h1.146c3.715,0,6.624-2.198,6.624-5.003v-3.624l6.86,0.08c0.008,0,0.015,0,0.021,0
                    ...
                    c1.537,0.166,2.521,0.939,2.521,1.471v10.575c0,0.532-0.983,1.305-2.521,1.471V-89.764z'
                          ></path>
                          <path
                            d='M46.358-89.728c-0.679-0.2-1.376-0.301-2.071-0.301c-4.033,0-7.314,3.281-7.314,7.314c0,4.033,3.281,7.314,7.314,7.314
                    c0.698,0,1.396-0.102,2.074-0.303c0.742-0.22,1.252-0.903,1.252-1.678v-10.667C47.613-88.825,47.102-89.509,46.358-89.728z
                     M44.113-78.905c-2.022-0.091-3.641-1.766-3.641-3.811s1.618-3.719,3.641-3.81V-78.905z'
                          ></path>
                          <path
                            d='M67.696-90.029c-0.698,0-1.396,0.102-2.073,0.302c-0.743,0.22-1.254,0.903-1.254,1.678v10.667
                    ...
                    S69.892-78.996,67.869-78.905z'
                          ></path>
                          <path
                            d='M60.797-95.629h-5.714c-3.142,0-5.697,2.555-5.697,5.696v14.929c0,3.141,2.556,5.696,5.697,5.696h5.714
                    ...
                    c-1.211,0-2.197-0.985-2.197-2.196v-14.929c0-1.211,0.986-2.196,2.197-2.196h3.964V-72.808z'
                          ></path>
                          <path
                            d='M33.357-59.117h-1.145c-3.715,0-6.625,2.198-6.625,5.003v3.687c-1.186-0.07-4.159-0.172-9.844,0.038
                    ...
                    c0,2.806,2.91,5.003,6.625,5.003h1.145c0.967,0,1.75-0.784,1.75-1.75v-17.081C35.107-58.333,34.324-59.117,33.357-59.117z
                     M31.607-42.068c-1.536-0.166-2.52-0.939-2.52-1.471v-10.575c0-0.532,0.983-1.305,2.52-1.471V-42.068z'
                          ></path>
                          <path
                            d='M46.358-55.548c-0.679-0.2-1.376-0.301-2.071-0.301c-4.033,0-7.314,3.281-7.314,7.314s3.281,7.314,7.314,7.314
                    c0.697,0,1.395-0.102,2.072-0.302c0.744-0.22,1.254-0.903,1.254-1.678V-53.87C47.613-54.646,47.102-55.329,46.358-55.548z
                     M44.113-44.726c-2.022-0.091-3.641-1.765-3.641-3.81s1.618-3.719,3.641-3.81V-44.726z'
                          ></path>
                          <path
                            d='M67.696-55.85c-0.698,0-1.396,0.102-2.073,0.302c-0.743,0.22-1.254,0.903-1.254,1.678v10.667
                    c0,0.776,0.512,1.459,1.256,1.679c0.678,0.2,1.375,0.301,2.071,0.301c4.032,0,7.313-3.281,7.313-7.314S71.728-55.85,67.696-55.85z
                     M67.869-44.726v-7.62c2.023,0.091,3.641,1.765,3.641,3.81S69.892-44.816,67.869-44.726z'
                          ></path>
                          <path
                            d='M60.797-61.45h-5.714c-3.142,0-5.697,2.556-5.697,5.697v14.929c0,3.141,2.556,5.696,5.697,5.696h5.714
                    ...
                    c-1.211,0-2.197-0.985-2.197-2.196v-14.929c0-1.211,0.986-2.197,2.197-2.197h3.964V-38.628z'
                          ></path>
                          <path
                            d='M93.373-50.684c-0.002,0-0.003,0-0.004,0l-6.878,0.013v-3.443c0-2.805-2.909-5.003-6.624-5.003H78.72
                    ...
                    v-13.517c1.537,0.166,2.521,0.939,2.521,1.471V-43.539z'
                        ...
                        <g>
                          <path
                            d='M212.092-110.176c-0.368-0.894-1.393-1.319-2.285-0.95c-14.081,5.809-28.165,11.609-42.251,17.41
                    ...
                    c14.085-5.801,28.171-11.602,42.253-17.411C212.035-108.259,212.46-109.283,212.092-110.176z'
                          ></path>
                          <path
                            d='M154.745-86.546c-0.368-0.894-1.39-1.318-2.285-0.951l-26.193,10.792c-0.895,0.368-1.32,1.392-0.951,2.285
                    ...
                    z'
                          ></path>
                          <path
                            d='M159.784-82.941h6.537v9.608c0,0.966,0.784,1.75,1.75,1.75c0.967,0,1.75-0.784,1.75-1.75v-11.038
                    ...
                    C158.034-83.725,158.818-82.941,159.784-82.941z'
                          ></path>
                          <path
                            d='M192.761-69.237h-49.364c-3.221,0-5.841,2.62-5.841,5.841v18.25c0,3.75,6.678,17.612,10.677,17.612h41.628
                    ...
                    c0-1.291,1.05-2.341,2.341-2.341h49.364c1.291,0,2.342,1.05,2.342,2.372C195.105-63.229,195.341-49.704,195.104-44.5z'
                          ></path>
                          <path
                            d='M150.556-44.846h3.982c2.904,0,5.268-2.363,5.268-5.267v-4.814c0-2.904-2.363-5.268-5.268-5.268h-3.982
                    ...
                    c-0.975,0-1.768-0.793-1.768-1.767V-54.927z'
                          ></path>
                          <path
                            d='M165.937-44.846h3.982c2.904,0,5.268-2.363,5.268-5.267v-4.814c0-2.904-2.363-5.268-5.268-5.268h-3.982
                    ...
                    c-0.974,0-1.766-0.793-1.766-1.767V-54.927z'
                          ></path>
                          <path
                            d='M185.386-60.195h-3.983c-2.903,0-5.267,2.363-5.267,5.268v4.814c0,2.903,2.363,5.267,5.267,5.267h3.983
                    ...
                    c0.975,0,1.767,0.793,1.767,1.768V-50.113z'
                          ></path>
                          <path
                            d='M188.479-42.124l-41.009-0.098c-0.001,0-0.002,0-0.004,0c-0.965,0-1.748,0.781-1.75,1.746
                    ...
                    S189.445-42.122,188.479-42.124z'
                        ...
                        <g>
                          <path
                            d='M316.401-71.413l-4.972-3.249c-0.58-0.378-1.247-0.57-1.915-0.57c-0.571,0-1.145,0.14-1.666,0.422
                    ...
                    V-65.236z M292.694-46.692l-3.246-4.973h6.494L292.694-46.692z M309.515-65.236v-6.495l4.973,3.249L309.515-65.236z'
                          ></path>
                          <path
                            d='M288.9-97.144c0.966,0,1.75-0.784,1.75-1.75v-5.381l4.937,6.445c0.338,0.441,0.855,0.686,1.39,0.686
                    ...
                    v10.544C287.15-97.928,287.935-97.144,288.9-97.144z'
                          ></path>
                          <path
                            d='M332.812-66.997c0.967,0,1.75-0.784,1.75-1.75s-0.783-1.75-1.75-1.75h-7.229v-1.76h7.229c0.967,0,1.75-0.784,1.75-1.75
                    ...
                    s-0.783-1.75-1.75-1.75h-7.229v-2.269H332.812z'
                          ></path>
                          <path
                            d='M297.919-33.715c-1.284-0.741-2.768-0.814-3.96-0.872c-0.25-0.013-0.495-0.024-0.731-0.042l-0.133-0.01
                    ...
                    C299.384-32.379,298.789-33.212,297.919-33.715z'
                          ></path>
                          <path
                            d='M262.987-75.41c-0.93-0.258-1.895,0.287-2.153,1.219l-1.481,5.345l-2.112-5.504c-0.276-0.722-0.98-1.146-1.713-1.113
                    ...
                    c0.755-0.036,1.4-0.553,1.604-1.28l2.899-10.46C264.466-74.187,263.919-75.151,262.987-75.41z'
                        ...
                        <g>
                          <path
                            d='M395.151-68.43c5.87,0,11.1-3.514,13.324-8.953c0.267-0.653,0.116-1.401-0.382-1.9l-16.486-16.486
                    ...
                    c-1.886,3.524-5.54,5.746-9.6,5.746c-6.009,0-10.897-4.888-10.897-10.896C384.254-86.886,386.476-90.541,390-92.427z'
                          ></path>
                          <path
                            d='M424.35-68.43c7.938,0,14.396-6.458,14.396-14.396c0-5.559-3.154-10.54-8.107-12.941v-13.27c0-0.966-0.783-1.75-1.75-1.75
                    ...
                    z'
                          ></path>
                          <path
                            d='M389.769-103.587c0.966,0,1.75-0.784,1.75-1.75v-3.701c0-0.966-0.784-1.75-1.75-1.75s-1.75,0.784-1.75,1.75v3.701
                    C388.019-104.371,388.803-103.587,389.769-103.587z'
                          ></path>
                          <path
                            d='M434.133-60.892h-24.301h-0.164h-24.301c-1.933,0-3.5,1.567-3.5,3.5v6.705c0,1.243,0.66,2.393,1.732,3.021
                    ...
                    h24.301h0.164h24.301V-55.475z'
                          ></path>
                          <path
                            d='M418.358-49.306c0.235,0.106,0.481,0.157,0.724,0.157c0.664,0,1.301-0.381,1.594-1.026l1.875-4.125
                    ...
                    C417.09-50.743,417.479-49.706,418.358-49.306z'
                        ...
                        <g>
                          <path
                            d='M-72.882,70.654c-0.599-1.086-1.163-2.112-1.489-3.195c-1.379-4.584-1.374-9.615-1.25-14.377
                    ...
                    c0.433,1.438,1.114,2.678,1.774,3.875c0.871,1.582,1.623,2.948,1.702,4.522C-73.999,81.738-77.436,87.076-81.908,88.763z'
                          ></path>
                          <path
                            d='M-80.204,42.987c-2.188-1.862-4.301-2.974-4.39-3.021c-0.857-0.448-1.913-0.116-2.361,0.741
                    ...
                    c0.495,0,0.987-0.209,1.334-0.616C-79.379,44.718-79.468,43.614-80.204,42.987z'
                          ></path>
                          <path
                            d='M-96.924,27.807c-4.922,2.285-7.963,9.238-8.706,14.732c-0.129,0.958,0.542,1.839,1.5,1.969
                    ...
                    c0.877-0.408,1.257-1.448,0.851-2.325C-95.008,27.779-96.051,27.4-96.924,27.807z'
                          ></path>
                          <path
                            d='M-79.918,72.965c0.535-0.806,0.316-1.892-0.488-2.427c-0.805-0.533-1.892-0.315-2.427,0.489
                    ...
                    C-81.888,75.889-79.997,73.082-79.918,72.965z'
                          ></path>
                          <path
                            d='M-78.695,77.489c-0.778-0.573-1.873-0.409-2.447,0.368c-0.013,0.017-1.256,1.647-3.363,2.623
                    ...
                    c2.985-1.36,4.701-3.652,4.772-3.749C-77.752,79.159-77.917,78.063-78.695,77.489z'
                          ></path>
                          <path
                            d='M-27.691,37.537c-2.372-9.876-11.649-18.887-21.578-20.959c-0.825-0.172-1.664-0.26-2.493-0.26
                    ...
                    c8.549,1.785,16.847,9.845,18.89,18.351C-30.011,42.86-30.029,47.526-30.69,52.043z'
                          ></path>
                          <path
                            d='M-34.526,34.44c-0.439-0.86-1.492-1.2-2.355-0.762c-0.86,0.44-1.201,1.494-0.762,2.355c1.098,2.148,1.852,4.56,2.181,6.977
                    ...
                    C-32.381,39.695-33.234,36.971-34.526,34.44z'
                          ></path>
                          <path
                            d='M-45.756,76.188c-1.049-0.184-2.122-0.466-3.189-0.84c-0.911-0.317-1.91,0.161-2.229,1.073s0.161,1.911,1.073,2.23
                    ...
                    C-44.167,77.262-44.804,76.355-45.756,76.188z'
                          ></path>
                          <path
                            d='M-49.587,81.265c-0.018-0.001-1.76-0.106-3.531-0.784c-2.105-0.975-3.355-2.613-3.363-2.623
                    ...
                    c0.923,0,1.693-0.723,1.744-1.655C-47.885,82.145-48.625,81.32-49.587,81.265z'
                        ...
                        <g>
                          <path
                            d='M31.81,30.987l22.715,4.006l-6.578,37.064c-0.17,0.952,0.465,1.86,1.417,2.028c0.104,0.019,0.206,0.027,0.308,0.027
                    ...
                    C36.328,19.458,42.828,13.038,50.97,10.88z'
                          ></path>
                          <path
                            d='M89.412,88.518c-0.006-1.434-0.027-8.387-0.014-13.552c0.001-0.672-0.382-1.285-0.986-1.579
                    ...
                    c4.865,0,13.305-0.572,19.693-4.04c-0.002,3.352,0.007,6.824,0.013,8.846H13.128z'
                          ></path>
                          <path
                            d='M11.431,54.854h22.918c0.901,0,1.656-0.686,1.742-1.582c0.039-0.423,0.063-0.85,0.063-1.281
                    ...
                    C13.474,46.265,17.719,42.225,22.89,42.225z'
                          ></path>
                          <path
                            d='M57.845,56.37c-0.966,0-1.75,0.783-1.75,1.75c0,0.966,0.784,1.75,1.75,1.75h18.271c0.966,0,1.75-0.784,1.75-1.75
                    c0-0.967-0.784-1.75-1.75-1.75H57.845z'
                          ></path>
                          <path
                            d='M11.375,59.87c0.007,0,0.014,0,0.021,0c11.472-0.13,23.335-0.136,35.261-0.015c0.006,0,0.012,0,0.018,0
                    ...
                    c-0.966,0.011-1.741,0.804-1.73,1.771C9.636,59.1,10.417,59.87,11.375,59.87z'
                          ></path>
                          <path
                            d='M11.375,65.628h34.06c0.967,0,1.75-0.784,1.75-1.75s-0.783-1.75-1.75-1.75h-34.06c-0.966,0-1.75,0.784-1.75,1.75
                    S10.409,65.628,11.375,65.628z'
                          ></path>
                        </g>
                        <path
                          d='M170.703,10.554c-22.063,0-40.011,17.949-40.011,40.011c0,22.063,17.948,40.012,40.011,40.012s40.012-17.949,40.012-40.012
                ...
                c0.087,0.013,0.174,0.026,0.264,0.026h16.406C203.853,72.025,192.166,83.713,177.37,86.455z'
                        ...
                        <g>
                          <path
                            d='M284.44,48.312c1.082,0.177,2.201,0.33,3.424,0.467c0.065,0.007,0.131,0.011,0.196,0.011c0.88,0,1.637-0.661,1.737-1.555
                    ...
                    C282.841,47.255,283.487,48.155,284.44,48.312z'
                          ></path>
                          <path
                            d='M311.065,49.628c1.368-2.942,2.083-6.157,2.083-9.431c0-12.423-10.2-22.531-22.739-22.531S267.67,27.774,267.67,40.197
                    ...
                    c4.319,0,8.843-0.324,11.897-1.402c16.625,2.41,24.225,7.334,24.225,10.941C332.995,69.535,315.614,75.963,290.674,75.963z'
                        ...
                        <g>
                          <path
                            d='M432.679,48.751c-0.989,0-1.986,0.099-2.978,0.292c-3.043-4.723-7.894-7.939-13.342-8.951
                    ...
                    S439.434,76.751,432.679,76.751z'
                          ></path>
                          <path
                            d='M416.01,32.251c0.448,0,0.896-0.171,1.237-0.513l5.667-5.667c0.684-0.683,0.684-1.792,0-2.475
                    c-0.684-0.684-1.791-0.684-2.475,0l-5.667,5.667c-0.684,0.683-0.684,1.792,0,2.475C415.114,32.08,415.562,32.251,416.01,32.251z'
                          ></path>
                          <path
                            d='M407.493,26.92c0.211,0.084,0.43,0.124,0.645,0.124c0.696,0,1.355-0.418,1.627-1.104l1.705-4.292
                    ...
                    C406.155,25.545,406.595,26.563,407.493,26.92z'
                          ></path>
                          <path
                            d='M399.188,25.189c0.01,0,0.021,0,0.03,0c0.966-0.016,1.737-0.813,1.72-1.779l-0.046-2.809
                    ...
                    <>
                      <svg
                        ...
                        viewBox='0 0 48 48'
                      >
                        <path fill='#1565c0' d='M23 11.9H25V36.1H23z'></path>
                        <path
                          fill='#1565c0'
                          d='M23 11.6H25V36.3H23z'
                          transform='rotate(-60.802 24 24)'
                        ></path>
                        <path
                          fill='#1565c0'
                          d='M11.6 23H36.3V25H11.6z'
                          transform='rotate(-29.208 23.998 23.998)'
                        ></path>
                        <path
                          fill='#1565c0'
                          d='M24,36.5l-4.7-4.5l-6.5-1.7l1.7-6.3l-1.7-6.3l6.5-1.7l4.7-4.5l4.7,4.5l6.5,1.7L33.4,24l1.7,6.3 l-6.5,1.7L24,36.5z M15.3,28.8l5,1.3l3.7,3.6l3.7-3.6l5-1.3L31.3,24l1.3-4.8l-5-1.3L24,14.3l-3.7,3.6l-5,1.3l1.3,4.8L15.3,28.8z'
                        ></path>
                        <path
                          fill='#2196f3'
                          d='M23 35H25V44H23zM23 4H25V13H23z'
                        ></path>
                        <path
                          fill='#2196f3'
                          d='M36.8 27H38.8V36.4H36.8z'
                          transform='rotate(-60.403 37.803 31.684)'
                        ></path>
                        <path
                          fill='#2196f3'
                          d='M9.1 11.7H11.1V20.799999999999997H9.1z'
                          transform='rotate(-60.797 10.081 16.222)'
                        ></path>
                        <path
                          fill='#2196f3'
                          d='M5.5 30.7H14.9V32.7H5.5z'
                          transform='rotate(-29.203 10.25 31.686)'
                        ></path>
                        <path
                          fill='#2196f3'
                          d='M33.1 15.3H42.400000000000006V17.3H33.1z'
                          transform='rotate(-29.203 37.8 16.286)'
                        ></path>
                        <path
                          fill='#2196f3'
                          d='M24 14.3L17.7 8.2 19.1 6.8 24 11.5 28.9 6.8 30.3 8.2zM28.9 41.2L24 36.5 19.1 41.2 17.7 39.8 24 33.7 30.3 39.8zM6.7 21.4L6.2 19.5 12.8 17.7 11.1 11.3 13 10.7 15.3 19.2zM35 37.3L32.7 28.8 41.3 26.6 41.8 28.5 35.2 30.3 36.9 36.7zM41.3 21.4L32.7 19.2 35 10.7 36.9 11.3 35.2 17.7 41.8 19.5zM13 37.3L11.1 36.7 12.8 30.3 6.2 28.5 6.7 26.6 15.3 28.8z'
                        ></path>
                      </svg>
                    </>
                  )}
              ...
              {/* Time of travel */}
              <p className='flex text-xl font-semibold items-center gap-1'>
                <div className='text-[27px] text-slate-500'>
                  <IoIosTimer />
                </div>
                {travelTime} {parseInt(travelTime) === 1 ? "Day" : "Day's"}
              </p>
              {/* People per year */}
              <p className='flex text-xl font-semibold items-center gap-1'>
              ...
              <div className=''>
                {coordinates ? (
                  <div className='h-40 md:h-72'>
                    <iframe
                      src={`https://www.google.com/maps?q=${coordinates.lat},${coordinates.lng}&t=k&hl=es;&output=embed`}
                      width='100%'
                      height='100%'
                      style={{ border: "0" }}
                      allowFullScreen
