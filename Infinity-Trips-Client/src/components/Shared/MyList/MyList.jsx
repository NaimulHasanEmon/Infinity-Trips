...
const MyList = () => {
  ...
  const mine = loadedData.filter((data) => data.userMail === user.email);
  console.log(mine);
  ...
  return (
    <div>
      {mine.length === 0 ? (
        <>
          <div className='py-20 text-center  spot-cart font-semibold'>
            <div className='text-4xl'>
              <p>You have not added anything yet!</p>
            </div>
            <div className='my-10'>
              <Link to=''>
                <button className='button-add p-2'>
                  ...
                  <div className='mx-auto'>
                    <img
                      className={`rounded-t-lg ${
                        mine.length > 2 ? "w-screen" : ""
                      } h-55 object-cover`}
                      src={imageURL}
                      alt={touristSpotName}
                    />
                  </div>
                  <div className='spot-cart text-xl'>
                    <p className='text-4xl font-semibold mt-2 border-b-2 pb-2 border-slate-200 border-dashed'>
                      {touristSpotName}
                    </p>
          ...
          c0.087,0.013,0.174,0.026,0.264,0.026h16.406C203.853,72.025,192.166,83.713,177.37,86.455z'
              ...
              C397.456,24.425,398.235,25.189,399.188,25.189z'
                    ...
                    <p className='flex items-center gap-1'>
                      ...
                      {travelTime}{" "}
                      {parseInt(travelTime) === 1 ? "Day" : "Day's"}
                    </p>
                    <p className='flex items-center gap-1'>
