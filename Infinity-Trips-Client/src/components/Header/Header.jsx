  ...
  return (
    <div className='navbar bg-base-100 border-b-2'>
      ...
      <div className='navbar-end flex gap-2'>
        {user ? (
          <div title={user.displayName || "Wolverine"}>
            {user.photoURL ? (
              <img
              ...
              >
                ...
                ></path>
                <path fill='#ffd600' d='M24 23L25.5 24.5 25 29 24 29z'></path>
                <path
                  fill='#fb8c00'
                ...
                ></path>
                <path fill='#ffd600' d='M24 23L22.5 24.5 23 29 24 29z'></path>
                <path fill='#ffd600' d='M23 21H25V24H23z'></path>
              </svg>
            )}
          </div>
        ) : (
          <FaRegCircleUser className='text-3xl' title='User Not Logged In' />
        )}
